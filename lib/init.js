...
function generatePkgJson(root) {
    ...
    // 合并 appPkg.json
    let appPkgJson = Object.assign({}, tempPkgJson, {
...
async function createApp(name) {
    ...
    console.log();
    console.log(`🚀 在 ${chalk.green(appPath)} 下创建新项目 ${name}：`);
    console.log();
    ...
    console.log();
    console.log(`🔨 即将安装项目依赖包，喝杯茶🍵，稍等一下...`);
    console.log();
...
function initProgram() {
    ...
    program
        ...
        .usage(`init ${chalk.green('<name>')} [options]`)
        // .arguments('<name>')
        .action(name => {
            projectName = name;
        })
        ...
        .on('--help', () => {
            console.log(
                `    只有项目目录名 ${chalk.green('<project-directory>')} 是必填参数。`
            );
            console.log();
            console.log(
